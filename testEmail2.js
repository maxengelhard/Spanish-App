...
+'                                <img alt="Descriptive Alt Text" height="auto" src="https://assets.opensourceemails.com/imgs/lifestyle/aijYy0SVQKSSTlLAJfBK_product-watch.jpg" style="border:none;display:block;font-size:13px;height:auto;outline:none;text-decoration:none;width:100%;" width="300" />'
+'                              </td>'
+'                            </tr>'
+'                          </tbody>'
+'                        </table>'
...
+'                          <tr>'
+'                            <td align="center" bgcolor="BLACK" role="presentation" style="background-color:BLACK;border:none;border-radius:0px;cursor:auto;padding:10px 25px;" valign="middle">'
+'                              <a href="#" style="background:BLACK;color:#ffffff;font-family:Helvetica, Arial, sans-serif;font-size:18px;font-weight:normal;line-height:120%;margin:0;text-decoration:none;text-transform:none;" target="_blank">'
+'                                Click Here Now'
+'                              </a>'
+'                            </td>'
+'                          </tr>'
...
+'                            <tr>'
+'                              <td style="width:300px;">'
+'                                <img alt="Descriptive Alt Text" height="auto" src="https://assets.opensourceemails.com/imgs/lifestyle/HzzPW0TUSwSE64ldofBd_product-laptop.jpg" style="border:none;display:block;font-size:13px;height:auto;outline:none;text-decoration:none;width:100%;" width="300" />'
+'                              </td>'
+'                            </tr>'
+'                          </tbody>'
+'                        </table>'
